        ...
        <div className={css(styles.filmstripLayout, styles.filmStrip)} aria-label={props.ariaLabel} ref={topElem}>
          ...
          >
            <IconButton
              ...
              iconProps={{ iconName: "ChevronLeft", styles: { root: { fontSize: '20px', fontWeight: '400' } } }}
            />
          </div>
          <div
            className={css(styles.indexButtonContainer, styles.sliderButtons)}
          ...
          >
            <IconButton
              ...
              iconProps={{ iconName: "ChevronRight", styles: { root: { fontSize: '20px', fontWeight: '400' } } }}
            />
          </div>
        </div>
      </div>
